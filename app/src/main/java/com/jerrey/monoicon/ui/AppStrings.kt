...
data class AppStrings(
    ...
    val scopeAppLauncher: String,
    val scopeAppSystemUi: String,
    ...
    val scopeRestart: String,
    val scopeRestartSummary: String,
    val restart: String,
...
private val ZH = AppStrings(
    ...
    scopeAppLauncher = "系统桌面",
    scopeAppSystemUi = "Android 系统",
    versionPrefix = "版本",
    logs = "日志",
    about = "关于",
    masterSwitch = "启用模块",
    ...
    scopeRestart = "重启作用域",
    scopeRestartSummary = "重装模块或切换主题/形状后，重启作用域内应用（桌面、系统界面）才能完全生效（首次需要授予 root）",
    restart = "重启",
    restarting = "重启中…",
    restartDone = "已重启作用域",
    restartFailed = "重启失败：请授予 MonoIcon root 权限",
    restartHint = "配置已修改，请重启作用域以完全生效。",
    logsTitle = "运行日志",
    logsRefresh = "刷新",
    logsEmpty = "暂无日志",
...
private val EN = AppStrings(
    ...
    scopeAppLauncher = "System launcher",
    scopeAppSystemUi = "Android System",
    ...
    scopeRestart = "Restart scope",
    scopeRestartSummary = "Restart the scoped apps (launcher, SystemUI) after reinstalling or switching theme/shape (root required once)",
    restart = "Restart",
    restarting = "Restarting…",
    restartDone = "Scope restarted",
    restartFailed = "Restart failed — grant MonoIcon root access",
    restartHint = "Configuration changed — restart the scope to apply.",
