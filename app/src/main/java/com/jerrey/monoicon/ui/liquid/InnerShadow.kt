...
//
// Ported from the Miuix example's `component/liquid/InnerShadow.kt`
// (https://github.com/compose-miuix-ui/miuix), itself adapted from
// Kyant0/AndroidLiquidGlass (Apache 2.0). Example-side helper, not part of any
// published Miuix artifact.
//
// Draws a shadow *inside* a shape by clipping to the shape's outline, offsetting
// the outline inward, and filling the ring between them with a blurred
// Clear-blended copy of the outline.
